    ...
    <main style={{ overflowX: "hidden", background: "#fff" }}>
      ...
      <section style={{ maxWidth: 1062, margin: "60px auto 0", padding: "0 24px" }}>
        <h2 style={{
          ...
          color: "#AB6430", textAlign: "center", lineHeight: "47px",
          margin: "0 0 48px 0",
        }}>
      ...
      <section style={{
        background: "#AB6430", padding: "89px 0",
        ...
        <div style={{ maxWidth: 946, margin: "0 auto", padding: "0 24px" }}>
          <h2 style={{
            fontFamily: "'Poppins', sans-serif", fontSize: 48, fontWeight: 600,
            color: "#DEA674", textAlign: "center", lineHeight: "29px",
            margin: "0 0 139px 0",
          }}>
                ...
                <div key={index} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <h3 style={{
                      ...
                      color: "#DEA674", textAlign: "left", lineHeight: "29px",
                      margin: "0 0 17px 0",
                    }}>
                      {item.title}
                    </h3>
        ...
        overflow: "hidden",
          ...
          <div style={{ position: "absolute", left: 136, bottom: 139, zIndex: 10 }}>
            ...
            <p style={{
              ...
              color: "#C5D7FA", margin: "0 0 16px 0",
            }}>
          ...
          <div
            ...
            style={{ position: "absolute", right: 192, bottom: 139, zIndex: 10, cursor: "pointer" }}
          >
            <div style={{
              width: 51, height: 51,
