...
export default function ContactPage() {
  ...
  return (
    <main style={{ overflowX: "hidden", background: "#F0F4F9", paddingTop: 100, position: 'relative' }}>
      {/* Hero Section */}
      <section style={{ 
        width: "100%", margin: 0, height: 260, position: "relative", 
        ...
        <div style={{ 
          ...
          {/* Phone Image */}
          <div style={{ width: 650, height: 580, position: "relative", marginTop: -169, marginBottom: 0 }}>
            <Image
          ...
          <div>
            <h1 style={{ 
              ...
              color: "#B3B3B3", lineHeight: "54px", margin: "0 0 8px 0"
            }}>
              Contact Us
            </h1>
            <p style={{ 
              fontFamily: "'Poppins', sans-serif", fontSize: 14, fontWeight: 300,
      ...
      <div style={{ padding: "40px 24px 80px 24px" }}>
        <div style={{ 
          ...
          borderRadius: 28, padding: "80px 60px", display: "flex", gap: 80
        }}>
          {/* Left: Contact Info */}
          <div style={{ flex: 1 }}>
            <p style={{ 
            ...
            <h2 style={{ 
              fontFamily: "'Poppins', sans-serif", fontSize: 48, fontWeight: 300,
              color: "#2F3E5A", lineHeight: "56px", margin: "0 0 16px 0"
            }}>
              Get in Touch
            </h2>
            <p style={{ 
              fontFamily: "'Poppins', sans-serif", fontSize: 16, fontWeight: 300,
              color: "#5D5D5E", lineHeight: "22px", margin: "0 0 32px 0",
              maxWidth: 280
            }}>
          ...
          <div style={{ flex: 1.3 }}>
            <div style={{ 
              background: "#D1DAEA", borderRadius: 24, padding: "60px 70px",
            ...
            {!showSuccess && (
              <form onSubmit={handleSubmit} style={{ position: "relative", zIndex: 10, marginTop: -25, display: "flex", flexDirection: "column", alignItems: "center" }}>
                <button 
                  ...
                  disabled={loading}
                  style={{
                  width: "70%", padding: "12px 24px", background: "#2F3E5A", color: "#97A7C7",
                  fontSize: 20, fontWeight: 600, borderRadius: 999, border: "none", cursor: "pointer",
